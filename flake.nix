{
  ...
  inputs = {
    ...
    myRib = { url = "github:JonathanReeve/rib"; };
    # Pin nixpkgs
  ...
  outputs = { self, nixpkgs, myRib, ... }@inputs:
      ...
      in {
        ...
        defaultPackage.x86_64-linux = self.packages.x86_64-linux.jonreeve-com;
        devShell = pkgs.mkShell self.packages.x86_64-linux.jonreeve-com;
      };
}
